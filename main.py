...
pd.set_option('display.float_format', '{:.2f}'.format)  # Round floats to 2 decimals
...
print("\nSorting all products by revenue \n")
...
print("\nThe Top product that got the highest revenue is: \n")
...
type_summary['Revenue_percent']=(type_summary['Total_Revenue']/total_revenue)*100
...
sns.barplot(x='Revenue', y='Product', data=products.head(10), palette='Set3')
